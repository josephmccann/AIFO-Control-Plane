...
class CommandTests(unittest.TestCase):
    ...
    def test_authenticated_history_derives_actor_and_authorizes_transition(self):
        ...
        ready = audit_event(
            ...
            source["created_at"], 1, None, {"nonce": "ready-1"},
        )
    ...
    def test_claim_proposal_revalidates_ready_state_and_records_lease_start(self):
        ...
        ready = audit_event(
            ...
            ready_source["created_at"], 1, None, {"nonce": "ready-20"},
        )
    ...
    def test_authenticated_recovery_bundle_projects_orphan_then_ready(self):
        ...
        ready = audit_event("mission.ready", "agent-a", "producer", ready_source["html_url"], ready_source["created_at"], 1, None, {"nonce": "ready-30"})
        ...
        released = audit_event(
            ...
            {"lease_owner": "agent-a", "lease_nonce": "github-comment-31", "recovery": True, "recommended_action": "Parked"},
        )
        history = authenticate_event_history(
