...
| High | Replit automatic schema diff can propose destructive production SQL | A publish proposed table drops from environment divergence and was canceled before promotion | Require exact generated-SQL review; stop on destructive/unexplained statements; implement one ledger |
| Medium | Startup health can be transiently 500 before stabilization | `3329c99` became healthy after startup completed | Separate liveness/readiness and require consecutive-success stabilization before promotion |
