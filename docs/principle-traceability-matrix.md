...
| 16 | Source systems remain authoritative | Integrations | Partial | Merged normalized observations retain provider/confidence and calibration suggestions remain editable; correction history and multi-tenant credentials remain unresolved | Preserve source/override lineage; do not treat suggestions as authoritative truth | Product `3329c99`, prerequisite plan items 4/6 |
