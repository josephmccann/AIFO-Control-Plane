...
| --- | --- | --- | --- | --- |
| OD-003 | Configure protected GitHub environments `terraform-plan` and `terraform-apply` | Human + Infrastructure | Before GitHub plan and any future apply workflow | Yes |
...
| OD-010 | Configure GitHub repository variables for Terraform plan | Human + Infrastructure | Before GitHub plan workflow can run | Yes |
