...
- **Rollback:** the authorization is unconsumed and can be superseded by a later correct authorization (the model supports replacement without rewriting history). A stale authorization is reported terminally and can never be attempted/consumed.
