...
| OD-015 | Decide whether to add automated host patching or keep manual patch windows | Resolved by ADR-0010: use approval-gated monthly manual patching for the single host; revisit automation at scale or for compliance |
