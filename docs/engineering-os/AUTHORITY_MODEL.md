...
unique record identifier, nonce, and exact authenticated GitHub source. A
durable consumed-record and consumed-nonce set rejects replay.
...
scopes, PR, head SHA, repository, expiry, and authenticated GitHub source.
